        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              $id = $_GET['id'];
              $qe= mysqli_query($koneksi, "SELECT * from tbl_pilihrestoran where id = '$id' ");
              ...
              ?>
                ...
                <form action="prosesupdate.php" method="POST">
                  <div class="card-body">
                    ...
                    <input type="text" name="idResto" value="<?= $data['id']; ?>" hidden>
                    <div class="form-group">
                      ...
                      <select name="pilihRestoran" onchange="random(this.value)" class="form-control custom-select">
                        <option><?= $data['pilihRestoran']; ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="pilihMenu" name="pilihMenu" class="form-control" value="<?= $data['pilihMenu'];?>" readonly>
                    </div>
                    
                    <div class="form-group">
                      <label for="hargaMenu">Harga Paket Menu</label>
                      <input type="text" id="hargaMenu" name="hargaMenu" class="form-control" value="<?= $data['hargaMenu'];?>" readonly>
                    </div>

                    <div class="form-group">
                      <label for="alamatPemesanan">Alamat Pemesanan</label>
                      <input type="text" name="alamatPemesanan" class="form-control" value="<?= $data['almt_pemesanan'];?>">
                    </div>

                    <div class="form-group">
                      <label for="namaLengkap">Nama Lengkap</label>
                      <input type="text" name="namaLengkap" class="form-control" value="<?= $data['nm_lengkap'];?>">
                    </div>

                    <div class="form-group">
                      <label for="nomorHape">No HP</label>
                      <input type="text" name="nomorHape" class="form-control" value="<?= $data['no_hp'];?>">
                    </div>

                    <div class="form-group">
                      <label for="alamatEmail">Alamat Email</label>
                      <input type="text" name="alamatEmail" class="form-control" value="<?= $data['almt_email'];?>">
                    </div>
                      <input type="submit" name="update" class="btn btn-success float-left" value="Update Pesanan">
                  </div>
